...
describe("Test Asus keygen", () => {
    test("Asus password for 2007-02-01 is AA19BALA", () => {
        expect(asusKeygen(2007, 2, 1)).toEqual("AA19BALA");
    });

    test("Asus password for 2017-10-12 is AABABLAL", () => {
        expect(asusKeygen(2017, 10, 12)).toEqual("AABABLAL");
    });

    test("Asus password for 2020-09-15 is LBD9DBA1", () => {
        expect(asusKeygen(2020, 9, 15)).toEqual("LBD9DBA1");
    });

    test("Asus password for 2012-03-29 is AOBOBL2B", () => {
        expect(asusKeygen(2012, 3, 29)).toEqual("AOBOBL2B");
    });

    test("Asus password for 2002-01-02 is ALAA4ABA", () => {
